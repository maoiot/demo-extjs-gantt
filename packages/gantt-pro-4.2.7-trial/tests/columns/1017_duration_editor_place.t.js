StartTest(function(t) {
    // Duration field with instantUpdate: true doesn't work well in IE
    // https://www.assembla.com/spaces/bryntum/tickets/2424-duration-field-is-not-working-in-ie9-10-with-instantupdate---true
    var method = Ext.isIE10m ? 'todo' : 'it';

    // Check if editor loses its position after locked grid refresh (#841)
    t[method]('Duration editor should remain in place', function (t) {
