StartTest(function (t) {
    ...
    var verifySequentialOrder = function (t, count) {
        for (var i = 0; i < count; i++)
            t.matchGridCellContent(gantt.lockedGrid, i, 2, i + 1);
    }
    ...
    t.it('Should keep the sequence after collapse/expand and CRUD', function (t) {
        ...
        t.chain(
            ...
            function (next) {
                ...
                var id = function (id) {
                    return gantt.taskStore.getNodeById(id)
                }
                ...
                t.it('Should show correct sequence code after re-ordering of the tasks', function (t) {
                    ...
                    t.chain(
                        {
                            drag     : function () {
                                return lockedView.getNode(id('Source'))
                            },
                            to       : function () {
                                return lockedView.getNode(id('Target'))
                            },
                            toOffset : ['50%', '50%+3']
                        },
                        function () {
                ...
                t.it('Should show correct sequence code after re-ordering of the tasks', function (t) {
                    ...
                    t.chain(
                        {
                            drag     : function () {
                                return lockedView.getNode(id('Source1'))
                            },
                            to       : function () {
                                return lockedView.getNode(id('Target2'))
                            },
                            toOffset : ['50%', '50%+3']
                        },
                        function () {
