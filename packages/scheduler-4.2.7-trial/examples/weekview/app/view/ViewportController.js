...
Ext.define('App.view.ViewportController', {
    ...
    getActiveScheduler  : function () {
        return this.lookup('tabpanel').activeTab;
    },
    ...
    onNavigationBarItemClick : function (item) {
        var scheduler = this.getActiveScheduler();
