...
App.Scheduler = {
    ...
    createScheduler : function () {
        ...
        var eventStore = App.eventStore = Ext.create("Sch.data.EventStore", {
            ...
            data  : [
                {Name          : 'Some task',
                    StartDate  : '2012-06-21 09:30',
                    EndDate    : '2012-06-21 12:00',
                    ResourceId : 'd',
                    Draggable  : true,
                    Deletable  : true
                },
                {Name          : 'You cannot delete me',
                    StartDate  : '2012-06-21 10:00',
                    EndDate    : '2012-06-21 13:00',
                    ResourceId : 'f',
                    Draggable  : true,
                    Deletable  : false
                }
        ...
        var ds = Ext.create("Sch.panel.SchedulerGrid", {
            ...
            border        : false,
            columns       : [
                {header : 'Staff', sortable : true, width : 130, dataIndex : 'Name', flex : true}
            ],
