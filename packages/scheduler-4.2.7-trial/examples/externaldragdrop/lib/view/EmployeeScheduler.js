...
Ext.define("MyApp.view.EmployeeScheduler", {
    ...
    eventRenderer : function (event, resourceRecord, meta) {
        var availabilityStore = this.resourceStore.availabilityStore;
    ...
    // Indicate if state is valid during dragging of planned tasks
    ...
    columns : [
        ...
        },
        {
            header   : 'Availability',
            flex     : 1,
            renderer : function (v, m, resource) {
                var D                 = Ext.Date;
                var availabilityStore = resource.store.availabilityStore;
                var availability      = availabilityStore.getEventsForResource(resource);
    ...
    initComponent           : function () {
        ...
        var availabilityStore = this.resourceStore.availabilityStore = this.resourceZones;
