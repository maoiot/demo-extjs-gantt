...
You have to copy config.template.php file to the same folder and name it config.php
Open this file and change paths for your environment.
...
and when exporting to PNG image:
    ...
    $cmd = IMGK_MONTAGE . " -mode concatenate -tile 1x $files \"$file\"";
