    ...
    createGrid: function () {
        ...
        Ext.define('Event', {
            ...
            fields: [
                ...
                {name: 'StartDate', type: 'date', mapping: 'c[1].f', dateFormat: 'm/d/Y'},
                {name: 'EndDate', type: 'date', mapping: 'c[2].f', dateFormat: 'm/d/Y'},
                ...
                load: function (store, records, successful) {
                    if (successful) {
                        ...
                        Ext.Array.forEach(records, function (record) {
                            rs.push({Id: record.getResourceId()});
                        });
        ...
        var g = Ext.create("Sch.panel.SchedulerGrid", {
            title        : 'GroupActivities (from Google Spreadsheet)',
            border       : false,
            bodyBorder   : false,
            height       : 300,
