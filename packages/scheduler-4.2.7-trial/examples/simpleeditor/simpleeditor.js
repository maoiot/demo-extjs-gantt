...
Ext.onReady(function () {
    ...
    // Store holding all the events
        eventStore = Ext.create('Sch.data.EventStore', {
            data: [
                {ResourceId: 'c1', Name: 'Mike', StartDate: "2017-12-09 09:45", EndDate: "2017-12-09 11:00"},
                {ResourceId: 'c2', Name: 'Linda', StartDate: "2017-12-09 10:15", EndDate: "2017-12-09 12:00"},
                {ResourceId: 'c3', Name: 'Don', StartDate: "2017-12-09 13:00", EndDate: "2017-12-09 15:00"},
                {ResourceId: 'c4', Name: 'Karen', StartDate: "2017-12-09 16:00", EndDate: "2017-12-09 18:00"},
                {ResourceId: 'c5', Name: 'Doug', StartDate: "2017-12-09 12:00", EndDate: "2017-12-09 13:00"},
                {ResourceId: 'c6', Name: 'Peter', StartDate: "2017-12-09 14:00", EndDate: "2017-12-09 16:00"}
            ]
        });
    ...
    var scheduler = Ext.create("Sch.panel.SchedulerGrid", {
        ...
        columns      : [
            {text: 'Animal', width: 130, flex: 1, dataIndex: 'Name', sortable: true}
        ],
