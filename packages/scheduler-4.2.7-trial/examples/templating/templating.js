/* global App: true, PerformanceBarTemplate: true */
    ...
    init: function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                var page = json.log.pages[0];

                var dt = Ext.Date.parse(page.startedDateTime, 'c');

                lineStore.add({
                    Date: Ext.Date.add(dt, Ext.Date.MILLI, page.pageTimings.onContentLoad),
                    Text: 'onContentLoad',
                    Cls : 'mytimeline'
                });
            }
        ...
        eventStore.on('load', function (store, records) {
