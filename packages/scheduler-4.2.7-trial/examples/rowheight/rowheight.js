...
App.SchedulerDemo = {
    ...
    init: function () {
            ...
            data: [
                {
                    ...
                    Name      : 'Fix bug',
                    State     : 0,
                    StartDate : "2017-12-09 10:00",
                    EndDate   : "2017-12-09 11:00"
                },
                {
                    Id        : 2,
                    ...
                    State     : 1,
                    StartDate : "2017-12-09 10:00",
                    EndDate   : "2017-12-09 12:00"
                },
                {
                    Id        : 3,
                    ResourceId: 'DonJohnson',
                    Name      : 'Fork project',
                    State     : 1,
                    StartDate : "2017-12-09 13:00",
                    EndDate   : "2017-12-09 15:00"
                },
                {
                    Id        : 4,
                    ...
                    State     : 2,
                    StartDate : "2017-12-09 16:00",
                    EndDate   : "2017-12-09 18:00"
                },
                {
                    Id        : 5,
                    ResourceId: 'DougHendricks',
                    Name      : 'Extend test suite',
                    State     : 2,
                    StartDate : "2017-12-09 12:00",
                    EndDate   : "2017-12-09 13:00"
                },
                {
                    Id        : 6,
                    ResourceId: 'PeterPan',
                    Name      : 'Fix IE issues',
                    State     : 3,
                    StartDate : "2017-12-09 14:00",
                    EndDate   : "2017-12-09 16:00"
                }
            ]
        });
        ...
        var sched = Ext.create("Sch.panel.SchedulerGrid", {
            ...
            startDate : new Date(2017, 11, 9, 8),
            endDate   : new Date(2017, 11, 9, 19),
            rowHeight : 40,
            ...
            columns: [
                {header: 'Name', sortable: true, tdCls: 'name', width: 200, flex: 1, dataIndex: 'Name'}
            ],
            ...
            items  : [
                {
                    xtype : 'component',
                    region: 'north',
                    html  : '<p>Here\'s an example showing how everything is dynamic in terms of changing the row and event heights. Use the two sliders to change the appearance of the chart.</p>' +
                    '<p>Note that the js for the example code is not minified so it is readable. See <a href="rowheight.js">rowheight.js</a>.</p>'
                },
                sched
            ]
