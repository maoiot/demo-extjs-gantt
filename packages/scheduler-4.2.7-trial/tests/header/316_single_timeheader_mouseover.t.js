StartTest(function (t) {
    ...
    t.it('Should highlight headercell when hovering mouse over it', function (t) {
        ...
        var steps = [
            { moveCursorTo : '.sch-header-row-top .sch-column-header' },
            ...
            { moveCursorTo : 'schedulerpanel[lockable=true] => .sch-header-row-middle .sch-column-header' },
            ...
            { moveCursorTo : 'schedulerpanel[lockable=true] => .sch-header-row-bottom .sch-column-header' },
    ...
    t.it('Should not highlight headercell when trackHeaderOver is false', function (t) {
        ...
        t.chain(
            ...
            function (next, headerEl) {
                ...
                t.selectorNotExists('.sch-column-header-over', 'No header cell has the "over class" applied to it');
                t.selectorNotExists('.x-column-header-over', 'Should not find default Ext overCls');
            });
    })
})
