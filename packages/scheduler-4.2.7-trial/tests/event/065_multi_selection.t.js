StartTest(function (t) {
    ...
    var setup = function (cfg) {
        ...
        scheduler = t.getScheduler({
            ...
            eventStore  : new Sch.data.EventStore({
                data    :[
                    { Id : 1, ResourceId : 1, Cls : 'sch-foo', StartDate : new Date(2010, 0, 1), EndDate : new Date(2010, 0, 2) },
                    { Id : 2, ResourceId : 1, Cls : 'sch-bar', StartDate : new Date(2010, 0, 2), EndDate : new Date(2010, 0, 3) }
                ],
                proxy   : 'memory'
            })
        });
    ...
    t.it('Should perform multiselect', function (t) {
        ...
        t.chain(
            ...
            { click : '.sch-bar', options : { ctrlKey : true } },
