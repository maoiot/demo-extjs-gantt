StartTest(function(t) {
    ...
    t.chain(
        ...
        function(next) {
            ...
            // https://www.assembla.com/spaces/bryntum/tickets/1991-drag-creator-proxy-el-style-not-reset-after-creating-an-event#/activity/ticket:
            var dragProxyEl = scheduler.el.down('.sch-dragcreator-proxy');
            t.is(dragProxyEl.getLeft(true), 0, 'left style reset');
            t.is(dragProxyEl.getTop(true), -10000, 'top style reset');
        ...
        { drag : Ext.grid.View.prototype.itemSelector + '[data-recordindex="1"] .sch-timetd', by : [-100, 0] },
