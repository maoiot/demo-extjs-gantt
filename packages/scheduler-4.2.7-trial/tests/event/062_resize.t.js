StartTest(function (t) {
    ...
    t.it('Basic use cases', function (t) {
        ...
        t.chain(
            ...
            { drag : '.sch-resizable-handle-start', by : [-100, 0] },
            ...
            function (next, el) {
                ...
                t.notOk(t.isElementVisible('.sch-resizable-handle-start'), 'Starting resize handler is not visible, so no resize operations is possible')
            ...
            { moveCursorTo : '.sch-event', offset : [0, '100%+5'] },
            ...
            { doubleClick : '.sch-resizable-handle-end' }
        );
    })

    t.it('Should finalize if mouse only moves a little', function (t) {
        scheduler = t.getScheduler({ renderTo : Ext.getBody(), height : 200 });
