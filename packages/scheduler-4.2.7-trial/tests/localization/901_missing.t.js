StartTest(function(t) {
    ...
    var ignoreRe = {
        RuRU    : /Sch\.preset\.Manager|Sch\.plugin\.exporter\.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay/,
        Pl      : /Sch\.preset\.Manager|Sch\.util\.Date\.unitNames|Sch\.plugin\.exporter\.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay/,
        SvSE    : /Sch\.preset\.Manager|Sch\.util\.Date\.unitNames|Sch\.plugin\.exporter\.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay/,
        De      : /Sch\.preset\.Manager|Sch\.util\.Date\.unitNames|Sch\.plugin\.exporter\.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay/,
        It      : /Sch\.preset\.Manager|Sch\.util\.Date\.unitNames\.(QUARTER\.abbrev|MINUTE\.abbrev|SECOND\.abbrev|MILLI\..+)|Sch.plugin.exporter.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay/,
        Nl      : /Sch\.preset\.Manager|Sch\.util\.Date\.unitNames\.(WEEK\.(single|abbrev)|DAY\.abbrev|SECOND\.abbrev|MILLI)|Sch.plugin.exporter.AbstractExporter|Sch\.panel\.TimelineGridPanel\.weekStartDay|Sch\.panel\.TimelineTreePanel\.weekStartDay|dpiFieldLabel/
    };
    ...
    function assertLocale(t, master, tested) {
        ...
        !errors && t.pass(id +': Locale has no untranslated phrases');
    }
