...
StartTest(function (t) {
    ...
    t.it('Event function setResourceId can be overridden', function (t) {

        Ext.define('Sch.MyModel', {
        ...
        var event = new Sch.MyModel({ resource : 'c1', Name : 'Mike', StartDate : "2016-02-12 14:40", EndDate : "2010-02-12 14:45"});
        t.is(event.getResourceId(), 'c1', 'ResourceId is properly set');
        event.setResourceId('c2');
        t.is(event.getResourceId(), 'c2', 'ResourceId is properly set');
    });
