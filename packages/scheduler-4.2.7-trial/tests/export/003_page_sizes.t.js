StartTest(function(t) {
    ...
    var setIframe   = function (t, html) {
        iframe && iframe.parentNode.removeChild(iframe);

        iframe = t.setIframe({ html : html });
