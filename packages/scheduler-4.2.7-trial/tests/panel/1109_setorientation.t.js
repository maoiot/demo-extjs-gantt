StartTest(function (t) {
        ...
        t.chain(
            ...
            function (next) {
                t.firesOk({
                    ...
                    events     : {
                        // beforerefresh sometimes not fired when calling refreshView so refresh
                        // cannot be prevented => increase threshold
                        refresh : '<=3'
                    },
                    during     : function () {
                        scheduler.setOrientation('vertical');
                    },
                    desc       : '<= 3 refresh events fired by normal view'
                });
                ...
                t.firesOk({
                    ...
                    desc       : '<= 3 refresh events fired by locked view'
                });
    ...
    t.it('Zones are fine, rows are synced (vertical => horizontal => calendar)', function (t) {
        ...
        t.chain(
            ...
            { waitForSelector : '.sch-zone', desc : 'Should find zone els after setting orientation to horizontal'},
