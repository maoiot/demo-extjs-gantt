StartTest(function(t) {
    var isExt6 = Ext.versions.extjs.getMajor() === 6;
    ...
    Ext.Loader.setPath('Robo', '../../robo/lib/Robo')

    if (isExt6) {
        Ext.Loader.setPath('Ext', extFolder + '/classic/classic/src')
    } else {
        Ext.Loader.setPath('Ext', extFolder + '/src')
    }

    t.requireOk(
        // https://www.sencha.com/forum/showthread.php?303465-Ext.util.ItemCollection-not-required-by-Ext.Container&p=1109232#post1109232
        (isExt6 ? ['Ext.util.ItemCollection'] : []).concat([
