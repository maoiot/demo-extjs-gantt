StartTest(function (t) {
    ...
    t.waitForRowsVisible(scheduler, function () {
        ...
        t.is(t.safeSelect(Ext.grid.View.prototype.itemSelector + '[data-recordindex="12"] .x-grid-cell', scheduler.normalGrid.el.dom).getY() - viewTop, twelvePos, 'Rows in sync')
    });
});
