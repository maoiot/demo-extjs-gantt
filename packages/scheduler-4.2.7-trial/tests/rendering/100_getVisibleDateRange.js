StartTest(function (t) {
    ...
    t.chain(
        ...
        function(next) {
            ...
            // calculate amount of time that scrollbar takes
            var scrollTimeDelta = view.getDateFromCoordinate(Ext.getScrollbarSize().width, null, true) - view.timeAxis.getStart();
            t.isApprox(range.startDate, new Date(scheduler.getEnd() - amountVisible + scrollTimeDelta), tolerance, 'Start: Correct scroll to end date');
