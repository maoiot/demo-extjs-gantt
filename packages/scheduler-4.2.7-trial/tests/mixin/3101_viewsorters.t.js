...
StartTest(function (t) {
    ...
    var ObjectsUnitTest = function () {
        ...
        view.getEventStore = function() { return eventStore };
        ...
        var horizontalLayout = Ext.create('Sch.eventlayout.Horizontal', Ext.apply({ 
            timeAxisViewModel : view.timeAxisViewModel, 
            sortEvents : sorterFn,
            bandIndexToPxConvertFn  : view.horizontal.layoutEventVertically,
            bandIndexToPxConvertScope : view.horizontal
        }));
        var verticalLayout = Ext.create('Sch.eventlayout.Vertical', Ext.apply({ view : view, sortEvents : sorterFn }));
