StartTest(function (t) {
    ...
    t.it('Should select multiple cells on click with ctrl key being hold', function (t) {
        ...
        t.chain(
            ...
            function (next) {
                boxes.push(scheduler.el.down('.sch-cellplugin-active').getBox());
                next();
            },
    ...
    t.it('Multiple selection should save box sizes', function (t) {
        ...
        t.chain(
            ...
            {
                waitFor : function () {
                    return scheduler.el.query('.sch-cellplugin-clone').length === 2;
                }
            },
            function () {
                var boxes   = scheduler.el.query('.sch-cellplugin-clone');
    ...
    t.it('Should clear selection on simple cell click', function (t) {
        ...
        t.chain(
            ...
            { waitForSelectorNotFound : '.sch-cellplugin-clone' },
