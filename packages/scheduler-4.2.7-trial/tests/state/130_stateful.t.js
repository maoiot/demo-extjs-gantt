StartTest(function(t) {
    ...
    // #2580
    t.it('Should apply state to rendered scheduler', function (t) {
        ...
        t.waitForRowsVisible(function () {
            scheduler.applyState(scheduler.getState());
            t.pass('State applied');
        })
    });

    t.it('Should apply state after destroy', function (t) {
